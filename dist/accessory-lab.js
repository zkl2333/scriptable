...
// icon-color: orange; icon-glyph: lock;
// @script-id accessory-lab
// @version 1.0.0

// src/widgets/accessory-lab.js
var family = config.widgetFamily || "medium";
var isAccessory = family.startsWith("accessory");
var foreground = Color.dynamic(new Color("#17202B"), new Color("#F7FAFF"));
var accent = Color.dynamic(new Color("#7A4DFF"), new Color("#B7A2FF"));
var secondary = Color.dynamic(new Color("#17202B", 0.62), new Color("#F7FAFF", 0.68));
var makeRing = () => {
