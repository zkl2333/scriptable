...
const ink = Color.dynamic(new Color('#1B2430'), new Color('#F4F7FB'));
const muted = Color.dynamic(new Color('#687585'), new Color('#A6B2C1'));
const blue = Color.dynamic(new Color('#2F6BFF'), new Color('#8AA8FF'));
